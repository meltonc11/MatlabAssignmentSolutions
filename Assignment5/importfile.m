function [SubjectID,Age,Gender,Weight,Day1,Day2,Day3] = importfile(filename)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [SUBJECTID,AGE,GENDER,WEIGHT,DAY1,DAY2,DAY3] = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   [SUBJECTID,AGE,GENDER,WEIGHT,DAY1,DAY2,DAY3] = IMPORTFILE(FILENAME) Reads data from rows STARTROW through ENDROW of text
%   file FILENAME.
%
% Example:
...
% Auto-generated by MATLAB on 2016/10/18 18:34:00
